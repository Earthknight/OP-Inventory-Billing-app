...
double discountprice = (singlesellingcost - (singlesellingcost * discount/100));
              ...
              child: Container(
                ...
                child: ListView.builder(
                    itemCount: 1, itemBuilder: (BuildContext context, int index) {
                      return BillingCard(cost: discountprice, time: time, discount: discount, name: name, items: items,);
                }),
              ),
            ),
            PayementCard(time:time,items:items, sellingPrice: totalsellingcost, purchasePrice: totalpurchasePrice, discount: discount),
          ],
        ),
      ),
    );
